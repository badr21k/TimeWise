...
return [
    ...
    'navigation' => [
        ...
        'schedule' => 'exact:1 | level:3',      // Level 1 (Regular User) and Level 3+ (Team Lead and above)
    ...
    'controllers' => [
        ...
        'schedule' => [
            'index' => 'exact:1 | level:3',     // Schedule management - Level 1 and Level 3+ only
    ...
    'actions' => [
        ...
        'schedule.index' => 'exact:1 | level:3',
